...
local mappings = {
  ...
  -- mode_all
  { mode_all, "<-.>",      "<cmd>call win_move_separator(win(),5)<cr>",  { noremap = true, desc = "increase window width" } },
  { mode_all, "<-,>",      "<cmd>call win_move_separator(win(),-5)<cr>", { noremap = true, desc = "reduce window width" } },

  -- mode_nv
  { mode_nv,  "0",         "q",                                          { noremap = true, desc = "Macro" } },
  { mode_nv,  "<C-f>",     "/",                                          { noremap = true, desc = "Flash search" } },
  { mode_nv,  "<S-l>",     "$",                                          { noremap = true, desc = "move to the end of line" } },
  { mode_nv,  "<S-h>",     "0",                                          { noremap = true, desc = "move to the beginning of line" } },
  { mode_nv,  "<C-d>",     ctrl_d_cmd,                                   { noremap = true, desc = "move down 5 lines" } },
  { mode_nv,  "<C-u>",     ctrl_u_cmd,                                   { noremap = true, desc = "move up 5 lines" } },

  -- mode_n
  { mode_n,   "<C-S-l>",   "<cmd>bprevious<cr>",                         { desc = "Prev Buffer" } },
  { mode_n,   "<C-S-h>",   "<cmd>bnext<cr>",                             { desc = "Next Buffer" } },
